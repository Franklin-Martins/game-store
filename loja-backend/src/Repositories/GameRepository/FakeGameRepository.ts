...
export default class FakeGameRepository implements IGameRepository {
    private games:Game[] = [
        ...
        new Game('The Last of Us', 'https://images.hdqwalls.com/wallpapers/bthumb/the-last-of-us-part-ii-game-gn.jpg', 'The Last of Us é uma franquia de jogos eletrônicos de ação-aventura e survival horror exclusiva da PlayStation, criada por Neil Druckmann. A franquia é situada em um mundo pós-apocalíptico, com seres humanos hostis e criaturas canibalísticas infectadas por uma mutação do fungo cordyceps.'),
